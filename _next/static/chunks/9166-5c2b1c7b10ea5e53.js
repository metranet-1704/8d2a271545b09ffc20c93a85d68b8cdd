...
`,em=t=>{let{direction:e,reverse:r=!1,...n}=t;return tb(tq,{keyframes:(0,s.useMemo)(()=>(function(t,e){switch(e){case"down":return t?el:eo;case"right":return t?eu:ei;case"up":return t?ed:ec;default:return t?ef:es}})(r,e),[e,r]),...n})};t$`
  from {
    opacity: 0;
    transform: scale3d(0.3, 0.3, 0.3);
  }
